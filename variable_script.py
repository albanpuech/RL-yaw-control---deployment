...
dataset_file = 'assets/variable_wind.csv'
...
model_params = {
    ...
    'start_index_eval': 2100,
    'stop_index_eval': 4100,
    'filter_duration': 1,
...
eval_env = YawEnv(
    wind_timeseries,
    model_params['start_index_eval'],
    model_params['stop_index_eval'],
    model_params['ancestors'],
    model_params['filter_duration'],
    yaw_params,
    )
...
fig.tight_layout()
plt.savefig('figures/variable_results',dpi=600)
...
plt.legend()
plt.savefig('figures/variable_dataset',dpi=1000)
